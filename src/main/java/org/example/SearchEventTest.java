...
public class SearchEventTest {
    ...
    public void simpleTest() throws InterruptedException {
       ...
       MobileElement searchBar= driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View/android.widget.EditText");
       searchBar.click();
       searchBar.sendKeys("GameReboot");
       Thread.sleep(5000);
